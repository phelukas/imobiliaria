...
urlpatterns = [
    ...
    url(r'editcliente/(?P<pk>[0-9]+)/$',
        views.EditarClienteView.as_view(), name='editcliente'),
    url(r'deletarliente/(?P<pk>[0-9]+)/$',
        views.DeletarClienteView.as_view(), name='delcliente'),
    ...
    url(r'checkoutvenda/(?P<pk>[0-9]+)/$',
        views.CheckoutView.as_view(), name='checkout'),
    url(r'delvenda/(?P<pk>[0-9]+)/$',
        views.DeletarVendaView.as_view(), name='delvenda')
]
